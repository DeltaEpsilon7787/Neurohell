...
class Claptcha(object):
    ...
    def __init__(self, source, font,
        ...
        self.injectLine = kwargs.get('injectLine', False)
        self.morph_min = kwargs.get('morph_min_coeff', 0.2)
        self.morph_max = kwargs.get('morph_max_coeff', 0.7)
    ...
    def _rndLetterTransform(self, image):
        ...
        dx = w * random.uniform(self.morph_min, self.morph_max)
        dy = h * random.uniform(self.morph_min, self.morph_max)
